...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{../resultados/redes/network_evento_1.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{../resultados/redes/network_evento_2.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{../resultados/redes/network_evento_3.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{../resultados/redes/network_evento_4.png}
...
\begin{figure}[H]
  ...
  \begin{minipage}{0.48\linewidth}
    \centering
    \includegraphics[width=\linewidth]{../resultados/redes/network_evento_5.png}
    \caption{Rede Bipartida - Evento 5.}
    \label{fig:evt5}
  \end{minipage}\hfill
  \begin{minipage}{0.48\linewidth}
    \centering
    \includegraphics[width=\linewidth]{../resultados/redes/network_evento_6.png}
